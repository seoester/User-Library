...
class User {
	...
	*/
	...
	/**
	* �berpr�ft ob das angegebene Passwort das Passwort des Benutzers ist.
	*/
	...
	*/
	...
	/**
	* Gibt zur�ck, ob die Email Adresse des Benutzers aktiviert ist.
	*/
	...
	/**
	* Gibt alle aktuellen online Ids des aktuellen Benutzers als Array zur�ck
	*/
	...
	/**
	* �ffnet die angegebene online Id, wenn diese nicht existiert wird eine Exception geworfen
	*/
	...
	* Wenn $check true ist, werden Login-, Username und Emailadresse �berpr�ft bevor der Benutzer in die Datenbank geschrieben wird, es wird hingegen nicht �berpr�ft ob das Registrieren deaktiviert ist.
	* Die Methode kann deswegen auch eine der REGISTER_ Konstanten zur�ckgeben.
	*
	* @static
	*/
	...
	*/
	...
	/**
	* Gibt alle Benutzer zur�ck die aktuell online sind.
	* Benutzer werden in Form eines Array von User Objekten zur�ckgegeben.
	*
	* @static
	*/
